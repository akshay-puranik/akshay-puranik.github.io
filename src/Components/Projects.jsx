...
const Projects = () => {
  ...
  // const bnbw = [bnb1, bnb2, bnb3];
    ...
    const sampleProject = [
      {
        title: "project name",
        desc: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Adipisci dolor nihil expedita facilis eligendi omnis, eaque, ipsum quidem et distinctio fugiat voluptas ratione deserunt tempora esse! Maxime sit vitae quisquam.",
  ...
  return (
    ...
    <Grid p="100px" gap="40px" templateColumns="repeat(3,1fr)">
